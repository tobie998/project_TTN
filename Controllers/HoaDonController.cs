...
namespace ElectronicWEB.Controllers
{
    public class HoaDonController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaHD,TenHD,NgayDatHang,TongTien,MaKH,MaNV")] HOADON hOADON)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaHD,TenHD,NgayDatHang,TongTien,MaKH,MaNV")] HOADON hOADON)
        {
            if (ModelState.IsValid)
            {
